...
const Match = () => {
  //acceder a info de input de filter
  ...
  //prever que se envie la info sin validar campos del filtro
  ...
  const [url, setUrl] = useState(`${API_URL}/players`)
                ...
                <div className='row d-flex justify-content-around flex-wrap'>
                  {
                    name.map((item, i) => {
                      ...
                      return <UserCard nombre={item.firstname} apellido={item.lastname} edad={item.birthdate} key={i} sexo={item.gender} biografia={item.bio} experiencia={item.sport.experiencia}/>
                    })
                  }
