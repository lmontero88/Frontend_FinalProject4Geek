...
function PageDetailPlayer(props) {
    ...
    //post para crear el Match

    const crear_match = async () => {
        try {
            setLoading(true)
    ...
    //get para obtner info de jugador
                            ...
                            <div className='row d-flex justify-content-center'>
                                <div className="card col-md- ml-3" style={{ width: '18rem' }}>
                                    <div className="card-body">
                                        ...
                                        <p className="card-text"><u>Biografía: </u>{player.bio}</p>
                                        <div className='d-flex justify-content-between'>
                                            <button className="btn btn-primary" onClick={EnviarAtras}>Atrás</button>
                                            <button className="btn btn-secondary" onClick={crear_match}>Match</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
